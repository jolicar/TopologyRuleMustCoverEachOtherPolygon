## TP00RU04CP0002 Test that all dataset 1 3D polygons must be covered to dataset 2 2D polygons.
...
2. Have acces to [**TP00RU04CP0002_pol3D1_C.csv**]() and [**TP00RU04CP0002_pol2D2_C.csv**]() files.
