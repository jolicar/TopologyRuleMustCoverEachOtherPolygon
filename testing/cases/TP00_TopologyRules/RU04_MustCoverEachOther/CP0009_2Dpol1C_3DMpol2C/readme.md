## TP00RU04CP0009 Test that all dataset 1 2D polygons must be covered to dataset 2 3DM polygons.
...
2. Have acces to [**TP00RU04CP0009_pol2D1_C.csv**]() and [**TP00RU04CP0009_pol3DM2_C.csv**]() files.
